  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-grow">
        {/* About Section */}
        <section id="about" className="bg-secondary/30 overflow-hidden">
        ...
        <section id="listings" className="bg-background overflow-hidden">
          <div className="container mx-auto px-6 md:px-10">
        ...
        {/* Services Section */}
        <section id="services" className="bg-secondary/30 overflow-hidden">
            <div className="container mx-auto px-6 md:px-10">
                <MotionWrapper className="text-center max-w-3xl mx-auto mb-12">
                ...
                <div className="grid md:grid-cols-3 gap-px bg-border">
                    {services.map((service, index) => (
                        <MotionWrapper key={service.title} delay={index * 0.15} className="h-full">
                            <div className="bg-background p-8 text-center flex flex-col items-center h-full">
        ...
        {/* Dubai Section */}
        <section id="dubai" className="relative bg-white text-foreground py-24 overflow-hidden">
        ...
        {/* Music Section */}
        <section id="music" className="bg-secondary/30 overflow-hidden">
            <div className="container mx-auto px-6 md:px-10">
                 <MotionWrapper>
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                         <div className="max-w-lg">
        ...
        {/* Contact Section */}
        <section id="contact" className="bg-secondary/30 overflow-hidden">
          <div className="container mx-auto px-6 md:px-10">
            <MotionWrapper className="max-w-2xl mx-auto text-center mb-12">
            ...
            <MotionWrapper delay={0.2} className="max-w-2xl mx-auto">
